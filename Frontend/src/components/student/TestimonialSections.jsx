...
const TestimonialSections = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='text-3xl font-medium text-gray-800'>TestimonialSections</h2>
      <p className='md:text-base text-gray-500 mt-3'>Hear from our learners as they share thier journeys of transformation, success and how our <br/> platform has made a difference in thier lives</p>
